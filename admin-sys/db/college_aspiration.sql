...
CREATE TABLE `college`  (
  ...
  `highest_score` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '最高分',
  `highest_locant` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '最高位次',
  `lowest_score` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '最低分',
  `lowest_locant` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '最低档次',
...
INSERT INTO `sys_log` VALUES (19, 'admin', '修改菜单', 'io.renren.modules.sys.controller.SysMenuController.update()', '{\"menuId\":41,\"parentId\":0,\"parentName\":\"一级菜单\",\"name\":\"推荐的冲稳保院校\",\"url\":\"modules/sys/recommendCollege.html\",\"type\":1,\"icon\":\"fa fa-bookmark-o\",\"orderNum\":0}', 5, '0:0:0:0:0:0:0:1', '2022-02-12 17:51:01');
INSERT INTO `sys_log` VALUES (20, 'admin', '修改菜单', 'io.renren.modules.sys.controller.SysMenuController.update()', '{\"menuId\":41,\"parentId\":0,\"parentName\":\"一级菜单\",\"name\":\"推荐的冲稳保院校\",\"url\":\"modules/sys/recommendCollege.html\",\"perms\":\"sys:college:list,sys:college:info,sys:college:save,sys:college:update\",\"type\":1,\"icon\":\"fa fa-bookmark-o\",\"orderNum\":0}', 3, '0:0:0:0:0:0:0:1', '2022-02-12 17:52:26');
INSERT INTO `sys_log` VALUES (21, 'admin', '修改菜单', 'io.renren.modules.sys.controller.SysMenuController.update()', '{\"menuId\":41,\"parentId\":0,\"parentName\":\"一级菜单\",\"name\":\"推荐的冲稳保院校\",\"url\":\"modules/sys/recommendCollege.html\",\"perms\":\"\",\"type\":1,\"icon\":\"fa fa-bookmark-o\",\"orderNum\":0}', 7, '0:0:0:0:0:0:0:1', '2022-02-12 18:07:47');
INSERT INTO `sys_log` VALUES (22, 'admin', '修改菜单', 'io.renren.modules.sys.controller.SysMenuController.update()', '{\"menuId\":41,\"parentId\":0,\"parentName\":\"一级菜单\",\"name\":\"推荐的冲稳保院校\",\"url\":\"modules/sys/recommendCollege.html\",\"perms\":\"sys:college:list,sys:college:info\",\"type\":1,\"icon\":\"fa fa-bookmark-o\",\"orderNum\":0}', 39, '0:0:0:0:0:0:0:1', '2022-02-12 18:09:28');
...
INSERT INTO `sys_menu` VALUES (42, 0, '所有可能录取院校', 'modules/business/all.html', NULL, 1, 'fa fa-bookmark-o', 0);
INSERT INTO `sys_menu` VALUES (43, 0, '向往已久的院校', 'modules/business/wishful.html', NULL, 1, 'fa fa-bookmark-o', 0);
INSERT INTO `sys_menu` VALUES (44, 0, '向往城市的院校', 'modules/business/wishfulcity.html', NULL, 1, 'fa fa-bookmark-o', 0);
